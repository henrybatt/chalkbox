...
public class BugFixes
    ...
    private double providedPassing;
    private double providedFailing;
    ...
    public BugFixes(
        double weighting,
        double providedPassing,
        double providedFailing
    ) {
        this();
    ...
    public StageResult run(Submission submission, Solution solution)
        ...
        double scaled = Math.ceil(
            100 * Math.max(0, (total - providedPassing) / providedFailing)
        );
